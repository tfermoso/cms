...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Tag'), ['action' => 'edit', $tag->slug], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Tag'), ['action' => 'delete', $tag->slug], ['confirm' => __('Are you sure you want to delete # {0}?', $tag->slug), 'class' => 'side-nav-item']) ?>
